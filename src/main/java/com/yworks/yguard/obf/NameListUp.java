...
public interface NameListUp {
   ...
   */
  String getMethodOutNameUp( String name, String descriptor ) throws ClassNotFoundException;
   ...
   * @throws ClassNotFoundException the class not found exception
   */
  String getMethodObfNameUp( String name, String descriptor ) throws ClassNotFoundException;
   ...
   * @throws ClassNotFoundException the class not found exception
   */
  String getFieldOutNameUp( String name ) throws ClassNotFoundException;
   ...
   * @throws ClassNotFoundException the class not found exception
   */
  String getFieldObfNameUp( String name ) throws ClassNotFoundException;
}
