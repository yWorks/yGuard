...
public interface NameMapper
{
    ...
    /**
     * Return a list of attributes marked to keep.  @param className the class name
     *
     * @return the string [ ]
     */
    ...
    /**
     * Mapping for fully qualified class name.  @param className the class name
     *
     * @return the string
     */
    ...
    /**
     * Mapping for method name, of fully qualified class.  @param className the class name
     *
    ...
    /**
     * Mapping for an annotation field/method, of fully qualified annotation class.  @param className the class name
     *
    ...
    /**
     * Mapping for field name, of fully qualified class.  @param className the class name
     *
    ...
    /**
     * Mapping for descriptor of field or method.  @param descriptor the descriptor
     *
     * @return the string
     */
    ...
    /**
     * Mapping for signature of field or method.  @param signature the signature
     *
     * @return the string
     */
    ...
    /**
     * Mapping for the source file attribute of a file.  @param className the class name
     *
    ...
    /**
     * Mapping for package name.  @param packageName the package name
     *
     * @return the string
     */
