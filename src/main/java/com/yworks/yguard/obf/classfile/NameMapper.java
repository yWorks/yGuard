...
public interface NameMapper {
   ...
   * @return the string [ ]
   */
  String[] getAttrsToKeep( String className );
   ...
   * @return the string
   */
  String mapMethod( String className, String methodName, String descriptor );
   ...
   * @return the string
   */
  String mapAnnotationField( String className, String annotationFieldName );
   ...
   * @return the string
   */
  String mapField( String className, String fieldName );
   ...
   * @return the string
   */
  String mapSignature( String signature );
   ...
   * @return the string
   */
  String mapSourceFile( String className, String sourceFile );
   ...
   */
  boolean mapLineNumberTable( String className, String methodName, String methodSignature, LineNumberTableAttrInfo info );
   ...
   * @return the string
   */
  String mapLocalVariable( String thisClassName, String methodName, String descriptor, String string );
   ...
   * @return the string
   */
  String mapPackage( String packageName );
}
