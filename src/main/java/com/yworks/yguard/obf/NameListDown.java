...
public interface NameListDown {
   ...
   */
  String getMethodObfNameDown( Cl caller, String name, String descriptor ) throws ClassNotFoundException;
   ...
   * @throws ClassNotFoundException the class not found exception
   */
  String getFieldObfNameDown( Cl caller, String name ) throws ClassNotFoundException;
}
