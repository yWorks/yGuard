...
public class ExposeSection extends Exclude {
  ...
  private final List classes = new ArrayList(5);
  private final List packages = new ArrayList(5);
  private final List patterns = new ArrayList(5);
  private final List methods = new ArrayList(5);
  private final List fields = new ArrayList(5);
  private final List attributes = new ArrayList(5);
  private final List lineNumberTables = new ArrayList(5);
  private final List sourceFiles = new ArrayList(5);
