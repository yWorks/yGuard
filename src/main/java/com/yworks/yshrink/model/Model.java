...
public class Model {
  ...
  private final Map<Object, Object> dependencyTypes;
  /**
  ...
  private final Node entryPointNode;
   ...
   */
  public static String VOID_DESC = Type.getMethodDescriptor(Type.VOID_TYPE);
  /**
